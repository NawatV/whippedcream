  ...
  <form class="form-horizontal style-form" method="post">
    ...
    <div class="row form-group">
      <div class="col-xs-12 col-lg-12" align="left" style="padding-left: 5px">
        ...
        <div class="col-sm-10">
          <select id = "dep_list" name='department' style="width: 100%; border-radius: 5px; height: 35px; border-color: #cccccc">
        ...
        <div class="col-xs-10 col-lg-10">
       		<div class="row">
       			<div class="col-xs-12 col-lg-12">
       				...
       				<input type="checkbox" name="mon_mor" value="1" style="margin-top: 8px; margin-right: 3px"> 9:00-11:30 น. </input>
          			<input type="checkbox" name="mon_af" value="2" style="margin-top: 8px; margin-right: 3px; margin-left: 40px"> 13:00-15:30 น. </input>
       			</div>
       		</div>
       		<div class="row">
       			<div class="col-xs-12 col-lg-12">
       				<label class="col-xs-2 col-lg-2 control-label">วันอังคาร</label>
       				<input type="checkbox" name="tue_mor" value="1" style="margin-top: 8px; margin-right: 3px"> 9:00-11:30 น. </input>
          			<input type="checkbox" name="tue_af" value="2" style="margin-top: 8px; margin-right: 3px; margin-left: 40px"> 13:00-15:30 น. </input>
       			</div>
       		</div>
       		<div class="row">
       			<div class="col-xs-12 col-lg-12">
       				<label class="col-xs-2 col-lg-2 control-label">วันพุธ</label>
       				<input type="checkbox" name="wed_mor" value="1" style="margin-top: 8px; margin-right: 3px"> 9:00-11:30 น. </input>
          			<input type="checkbox" name="wed_af" value="2" style="margin-top: 8px; margin-right: 3px; margin-left: 40px"> 13:00-15:30 น. </input>
       			</div>
       		</div>
       		<div class="row">
       			<div class="col-xs-12 col-lg-12">
       				<label class="col-xs-2 col-lg-2 control-label">วันพฤหัสบดี</label>
       				<input type="checkbox" name="thu_mor" value="1" style="margin-top: 8px; margin-right: 3px"> 9:00-11:30 น. </input>
          			<input type="checkbox" name="thu_af" value="2" style="margin-top: 8px; margin-right: 3px; margin-left: 40px"> 13:00-15:30 น. </input>
       			</div>
       		</div>
       		<div class="row">
       			<div class="col-xs-12 col-lg-12">
       				<label class="col-xs-2 col-lg-2 control-label">วันศุกร์</label>
       				<input type="checkbox" name="fri_mor" value="1" style="margin-top: 8px; margin-right: 3px"> 9:00-11:30 น. </input>
          			<input type="checkbox" name="fri_af" value="2" style="margin-top: 8px; margin-right: 3px; margin-left: 40px"> 13:00-15:30 น. </input>
       			</div>
       		</div>
       		<div class="row">
       			<div class="col-xs-12 col-lg-12">
       				<label class="col-xs-2 col-lg-2 control-label">วันเสาร์</label>
       				<input type="checkbox" name="sat_mor" value="1" style="margin-top: 8px; margin-right: 3px"> 9:00-11:30 น. </input>
          			<input type="checkbox" name="sat_af" value="2" style="margin-top: 8px; margin-right: 3px; margin-left: 40px"> 13:00-15:30 น. </input>
       			</div>
       		</div>
       		<div class="row">
       			<div class="col-xs-12 col-lg-12">
       				<label class="col-xs-2 col-lg-2 control-label">วันอาทิตย์</label>
       				<input type="checkbox" name="sun_mor" value="1" style="margin-top: 8px; margin-right: 3px"> 9:00-11:30 น. </input>
          			<input type="checkbox" name="sun_af" value="2" style="margin-top: 8px; margin-right: 3px; margin-left: 40px"> 13:00-15:30 น. </input>
       			</div>
       		</div>
        </div>
      </div>
