...
@if(Session::get('create_phar_error') == 1)
...
@endif
@if(Session::get('create_phar_error') == 2)
<div id="error-popup" class="admin-popup-position-dont-hide" style="z-index: 2">
  <div id="admin-error-popup-wrapper">
    <div id="admin-error-popup-container" align="center">
      <div style="font-size: 18px; float: right; position: relative; left: 10px">
...
@endif
@if(Session::get('create_phar_error') == 3)
<div id="error-popup" class="admin-popup-position-dont-hide" style="z-index: 2">
  <div id="admin-error-popup-wrapper">
    <div id="admin-error-popup-container" align="center">
      <div style="font-size: 18px; float: right; position: relative; left: 10px">
...
@endif
@if(Session::get('create_phar_error') == 4)
<div id="error-popup" class="admin-popup-position-dont-hide" style="z-index: 2">
  <div id="admin-error-popup-wrapper">
    <div id="admin-error-popup-container" align="center">
      <div style="font-size: 18px; float: right; position: relative; left: 10px">
...
@endif
@if(Session::get('create_phar_error') == 5)
<div id="error-popup" class="admin-popup-position-dont-hide" style="z-index: 2">
  <div id="admin-error-popup-wrapper">
    <div id="admin-error-popup-container" align="center">
      <div style="font-size: 18px; float: right; position: relative; left: 10px">
...
<div class="create-account-form-panel">
  <h4 class="ml mb"><i class="fa fa-angle-right"></i> สร้างบัญชีผู้ใช้: เภสัชกร</h4>
  <form class="form-horizontal style-form" method="post">
    ...
    <div class="row form-group">
      <div class="col-xs-12 col-lg-12" align="left" style="padding-left: 5px">
        <label class="col-xs-2 col-lg-2 control-label">เลขประจำตัวเภสัชกร</label>
        <div class="col-sm-10">
          @if(Session::has('old_value'))
            <input type="text" class="form-control" name="pharmacistNumber" value="{{Session::get('old_value')['pharmacistNumber']}}">
          @else
            <input type="text" class="form-control" name="pharmacistNumber">
          @endif
        </div>
      </div>
    </div>
