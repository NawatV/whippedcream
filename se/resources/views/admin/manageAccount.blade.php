...
<div id="inform_user_popup" class="admin-popup-position-dont-hide" style="z-index: 2">
  <div id="admin-popup-wrapper">
    <div id="admin-popup-container">
      ...
      <h3 style="margin-top: 18px; margin-bottom: 15px; padding-bottom: 12px; border-bottom: 1px solid #e3e6ea; text-align: center">สร้างบัญชีสำเร็จ</h3>
      ...
      <p style="font-size: 16px; margin-bottom: 15px"> รหัสผ่าน: {{Session::get('generated_password')}}</p>
...
<!--start of  search form-->
  <div class="col-xs-12 col-lg-12">
  	<h4 style="margin-top: -3px;margin-bottom: 15px; margin-left: 10px" align="left"><i class="fa fa-angle-right"></i> ค้นหา </h4>
  </div>
</div>
<!--mt2 is new-->
    ...
    <div class="row">
      <div class="search-form-group">
        ...
        <div class="col-xs-4 col-lg-4">
          <input type="text" class="form-control" name='name' placeholder="{{$name}}" onfocus="this.placeholder = ''">
        </div>
        <!--Department-->
        <label class="col-xs-offset-1 col-lg-offset-1 col-xs-1 col-lg-1 control-label mt2">แผนก</label>
        <div class="col-xs-4 col-lg-4">
          <input type="text" class="form-control" name='department' placeholder="{{$dep}}" onfocus="this.placeholder = ''">
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="search-form-group">
        ...
        <div class="col-xs-3 col-lg-3">
          <input type="text" class="form-control" name='id' placeholder="{{$id}}" onfocus="this.placeholder = ''">
        </div>
        <!--SSN-->
        <label class="col-xs-offset-1 col-lg-offset-1 col-xs-2 col-lg-2 control-label mt2">เลขประจำตัวประชาชน</label>
        <div class="col-xs-3 col-lg-3">
          <input type="text" class="form-control" name='ssn' placeholder="{{$ssn}}" onfocus="this.placeholder = ''">
        </div>
      </div>
    </div>
  ...
  <div class="account-list-area account-list-search-active">
    ...
    <div class="account-list-panel">
        ...
        <div id="edit_right_popup{{$user->index}}" class="admin-popup-position" style="z-index: 2">
          <div id="admin-popup-wrapper">
            <div id="admin-popup-container">
              <h4 style="margin-top: 18px; padding-bottom: 12px; border-bottom: 1px solid #e3e6ea; text-align: center">แก้ไขสิทธิ์: {{$user->firstname}} {{$user->lastname}}</h4>
              <form action="/manageAccount" method="post">
                ...
                <div class="row">
                  <div class="col-xs-6 col-lg-6">
                    ...
                    @endif
                    <div class="col-xs-12 col-lg-12">
                      <input type="checkbox" name="dia_H" value="Allow" checked style="margin-top: 9px; margin-right: 3px"> ดูประวัติคำวินิจฉัย </input>
                    </div>
                    <div class="col-xs-12 col-lg-12">
                      <input type="checkbox" name="pre_H" value="Allow" checked style="margin-top: 9px; margin-right: 3px"> ดูประวัติการสั่งยา </input>
                    </div>
                  </div>    
                  <div class="col-xs-6 col-lg-6">
                    <div class="col-xs-12 col-lg-12">
                ...
                <div align="center" style="margin-top: 16px">
                  <button type="button" class="btn btn-theme04 btn-lg" onclick="toggle_visibility('edit_right_popup{{$user->index}}');">ยกเลิก</button>
        ...
        <div id="delete_user_popup{{$user->index}}" class="admin-popup-position" style="z-index: 2">
          <div id="admin-popup-wrapper">
            <div id="admin-popup-container">
              <h4 style="margin-top: 18px; padding-bottom: 12px; border-bottom: 1px solid #e3e6ea; text-align: center">ลบบัญชี: {{$user->firstname}} {{$user->lastname}}</h4>
              <form action="/manageAccount" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="hidden" name="username" value="{{ $user->username }}">
                ...
                <div align="center" style="margin-top: 16px">
                  <button type="button" class="btn btn-theme04 btn-lg" onclick="toggle_visibility('delete_user_popup{{$user->index}}');">ยกเลิก</button>
                  <span style="margin-right: 10px"></span>
		        ...
		        <div class="account-detail hide">
                  ...
                  <div class="col-xs-1 col-lg-1" style="margin-top: 8px">                   
                    ...
                    @if ($user->userType == 'ผู้ป่วย')
                      ...
                      <div class="col-xs-4 col-lg-4">
                        <p><i class="fa fa-phone-square" style="margin-right: 5px"></i> {{$user->phoneNumber}}</p>
                      </div>
                      <div class="col-xs-8 col-lg-8">
                        <p><i class="fa fa-envelope" style="margin-right: 5px"></i> {{$user->email}}</p>
                      </div>
                      <div class="col-xs-12 col-lg-12">
                    ...
                    @else
                      ...
                      @endif
                      <div class="col-xs-4 col-lg-4">
                        <p><i class="fa fa-phone-square" style="margin-top: 10px; margin-right: 5px"></i> {{$user->phoneNumber}}</p>
                      </div>
                      <div class="col-xs-8 col-lg-8">
                        <p><i class="fa fa-envelope" style="margin-top: 10px; margin-right: 5px"></i> {{$user->email}}</p>
                      </div>
                      <div class="col-xs-12 col-lg-12">
                        <p><i class="fa fa-address-book" style="margin-right: 5px"></i> {{$user->address}}</p>
                      </div>
