...
<div id="error-popup" class="admin-popup-position-dont-hide" style="z-index: 2">
  <div id="admin-error-popup-wrapper">
    <div id="admin-error-popup-container" align="center">
      ...
      <h4 style="position: relative; bottom: 26px"> ชื่อแผนกมีอยู่แล้ว <br> ไม่สามารถเปลี่ยนชื่อแผนกได้ </h4>
    </div>  </div>
</div>
@endif
...
<div id="error-popup" class="admin-popup-position-dont-hide" style="z-index: 2">
  <div id="admin-error-popup-wrapper">
    <div id="admin-error-popup-container" align="center">
      ...
      <h4 style="position: relative; bottom: 26px"> ยังมีแพทย์หรือพยาบาลอยู่ในแผนก <br> ไม่สามารถลบแผนกได้ </h4>
    </div>  </div>
</div>
@endif
<div class="row">
      ...
      <div class="mt2">
        ...
        <div class="col-xs-5 col-lg-5" align="left">
          ...
          <div class="col-xs-10 col-lg-10">
            <input type="text" class="form-control" name='dep_name' placeholder="{{$departmentName}}" onfocus="this.placeholder = 'ทั้งหมด'">
          </div>
        </div>        
        <div class="col-xs-5 col-lg-5" align="left" >
    ...
    <div class="account-list-panel">
      ...
      <!--edit popup-->
        <div id="edit_dep_popup{{$department->index}}" class="admin-popup-position" style="z-index: 2">
          <div id="admin-popup-wrapper">
            <div id="admin-popup-container">
              <h4 style="margin-top: 18px; padding-bottom: 12px; border-bottom: 1px solid #e3e6ea; text-align: center">แก้ไขชื่อแผนก: {{$department->departmentName}}</h4>
              <form action="/manageDepartment" method="post">
                ...
                <div style="padding-left: 14px; margin-bottom: 8px; margin-top: 14px">
                  ...
                  <input type="text" name="new_name" placeholder="{{$department->departmentName}}">
                </div>
                <div align="center" style="margin-top: 16px">
                  <button type="button" class="btn btn-theme04 btn-lg" onclick="toggle_visibility('edit_dep_popup{{$department->index}}');">ยกเลิก</button>
        ...
        <div id="delete_dep_popup{{$department->index}}" class="admin-popup-position" style="z-index: 2">
          <div id="admin-popup-wrapper">
            <div id="admin-popup-container">
              <h4 style="margin-top: 18px; padding-bottom: 12px; border-bottom: 1px solid #e3e6ea; text-align: center">ลบแผนก: {{$department->departmentName}}</h4>
              <form action="/manageDepartment" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div align="center" style="margin-top: 16px">
                  <button type="button" class="btn btn-theme04 btn-lg" onclick="toggle_visibility('delete_dep_popup{{$department->index}}');">ยกเลิก</button>
                  <span style="margin-right: 10px"></span>
        ...
        <div>
            <div style="margin-left: 4px">
              <a href="#" class="account-row">
                  ...
                  <p class="account-excerpt col-xs-2 col-lg-2" style="padding-left: 8px">{{$department->departmentId}}</p>
                  <p class="account-excerpt col-xs-4 col-lg-4" style="padding-left: 16px">{{$department->departmentName}}</p>
                  <p class="account-excerpt col-xs-3 col-lg-3" style="padding-left: 20px">{{$department->location}}</p>
              </a>
