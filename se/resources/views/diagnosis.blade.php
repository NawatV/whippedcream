...
=======
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <select class="form-control" name="symptomcode">
                  <option value="icd10" {{ old('symptomcode') == 'icd10' ? 'selected' : ''}} >ICD10</option>
                  <option value="snowmed" {{ old('symptomcode') == 'snowmed' ? 'selected' : ''}} >SNOWMED</option>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label">รายละเอียดการวินิจฉัย</label>
              <div class="col-sm-10">
                <textarea class="form-control" rows="5" style="resize:vertical" name="details">{{ old('details') }}</textarea>
              </div>
            </div>
              ...
              @while(true)
                @if(old('drug'.$num))
                  <div class="form-group {{'drugGroup'.$num}}">
                    ...
                    <div class="col-sm-4">
                      <select class="form-control" id="{{'drug'.$num}}" name="{{'drug'.$num}}">
                        <option disabled {{ old('drug'.$num) ? '' : 'selected'}} >-- Select Medicine --</option>
                        <option {{ old('drug'.$num) == 'Aspirin'? 'selected' : ''}} >Aspirin</option>
                        <option {{ old('drug'.$num) == 'Chlorpheniramine Maleate'? 'selected' : ''}} >Chlorpheniramine Maleate</option>
                        <option {{ old('drug'.$num) == 'Dimenhydrinate'? 'selected' : ''}} >Dimenhydrinate</option>
                        <option {{ old('drug'.$num) == 'Mebendazole'? 'selected' : ''}} >Mebendazole</option>
                        <option {{ old('drug'.$num) == 'Paracetamol'? 'selected' : ''}} >Paracetamol</option>
                        <option {{ old('drug'.$num) == 'Ponstan'? 'selected' : ''}} >Ponstan</option>
                      </select>
                    </div>

                    <label class="col-sm-2 control-label">ปริมาณ</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="{{'quantity'.$num}}" name="{{'quantity'.$num}}" value="{{old('quantity'.$num)}}" {{ old('drug'.$num) ? '' : 'disabled'}}>
                    </div>
                  </div>
                  ...
                  <div class="form-group {{'drugGroup'.$num}}">
                    <label class="col-sm-2 control-label">วิธีใช้</label>
                    <div class="col-sm-10">
                      <textarea class="form-control" rows="5" style="resize:vertical" id="{{'usage'.$num}}" name="{{'usage'.$num}}" {{ old('drug'.$num) ? '' : 'disabled'}}>{{old('usage'.$num)}}</textarea>
                    </div>
                  </div>
                @else
                  @break
            ...
            @else
              <div class="form-group drugGroup1">
                ...
                <div class="col-sm-4">
                  <select class="form-control" id="drug1" name="drug1">
                    <option disabled {{ old('drug1') ? '' : 'selected'}} >-- Select Medicine --</option>
                    <option {{ old('drug1') == 'Aspirin'? 'selected' : ''}} >Aspirin</option>
                    <option {{ old('drug1') == 'Chlorpheniramine Maleate'? 'selected' : ''}} >Chlorpheniramine Maleate</option>
                    <option {{ old('drug1') == 'Dimenhydrinate'? 'selected' : ''}} >Dimenhydrinate</option>
                    <option {{ old('drug1') == 'Mebendazole'? 'selected' : ''}} >Mebendazole</option>
                    <option {{ old('drug1') == 'Paracetamol'? 'selected' : ''}} >Paracetamol</option>
                ...
                <label class="col-sm-2 control-label">ปริมาณ</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="quantity1" name="quantity1" value="{{old('quantity1')}}" {{ old('drug1') ? '' : 'disabled'}}>
                </div>
              </div>
              ...
              <div class="form-group drugGroup1">
                <label class="col-sm-2 control-label">วิธีใช้</label>
                <div class="col-sm-10">
                  <textarea class="form-control" rows="5" style="resize:vertical" id="usage1" name="usage1" {{ old('drug1') ? '' : 'disabled'}}>{{old('usage1')}}</textarea>
                </div>
              </div>
            @endif
