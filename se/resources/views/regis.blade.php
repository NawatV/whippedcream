      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="login.html">Sign In</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
          ...
          <section class="wrapper">
              ...
              <label class="col-sm-2">
                ...
                Female
                        ...
                        <div class="form-group">
                           <label class="col-sm-2 col-sm-2 control-label">Blood Type</label>
                           <div class="col-sm-10">
                        <div class="radio">
          	...
          	<button type="button" class="btn pull-right btn-theme04 btn-lg">Submit</button>
