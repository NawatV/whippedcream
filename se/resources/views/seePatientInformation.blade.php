        ...
        <div class="col-lg-12">
            <div class="form-panel">
                <div class="container-fluid">
                    <h3 class="mb"><i class="fa fa-angle-right"></i> &nbsp;ข้อมูลทั่วไป</h3>
                    <div class="form-horizontal style-form">
                        ...
                        <div class="form-group">
                            <div class="col-sm-2 col-lg-2 col-lg-offset-2">
                                <form action="findPatientFromHnIdNameForVitalSign" method="post">
                                    <input type="hidden" name="userId" value="{{$patients->userId}}">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <button type="submit" class="btn btn-primary btn-block"> ดูอาการทั่วไป</button>
                                </form>
                            </div>
                            <div class="col-sm-2 col-lg-2 col-lg-offset-1">
                                <form action="findPatientFromHnIdNameForDiagnosis" method="post">
                                    <input type="hidden" name="userId" value="{{$patients->userId}}">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <button type="submit" class="btn btn-primary btn-block"> ดูข้อมูลวินิจฉัย</button>
                                </form>
                            </div>
                            <div class="col-sm-2 col-lg-2 col-lg-offset-1">
